...
The idea was to create an implementation that is portable and simple, but also flexible (i.e. allows for use of custom data structures and distance calculations).
